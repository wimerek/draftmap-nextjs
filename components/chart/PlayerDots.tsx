...
// ── Filter function ────────────────────────────────────────────────────────────
// Lifted to lib/lensFilter.ts (Epsilon 4 brief f) — ONE scope predicate shared by
// Acts 1/2 (here), the Act 3 lens (JellyfishField), and the scoreboard scope, so the
// three can never disagree on "who's in scope". Imported above; behavior unchanged.
