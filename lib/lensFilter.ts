 ...
 *
 * ⚠ SCOPE-ONLY (7.0): this is position / round / team / school. It must NEVER learn
 * a display toggle (Hide Drafted, movement lines, dot size). `chartMode` and
 * `currentStepId` ride along ONLY as resolution context (which team/round field to
